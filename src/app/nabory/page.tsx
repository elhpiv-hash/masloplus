...
export const metadata = pageMetadata({
  ...
  description:
    "Готовые наборы ТО под ваш автомобиль: тарифы Бюджет и Премиум — масло, фильтры и цена. Поиск по марке. Автосервис «Масло Плюс», Чебоксары.",
  path: "/nabory",
});
      ...
      <Section surface="dark">
        <Container>
          ...
          <p className="mt-4 max-w-2xl text-muted">
            Масло и фильтры под конкретную модель — выберите тариф Бюджет или Премиум. Не нашли свою
            марку — оставьте заявку, подберём.
          </p>
        </Container>
      </Section>
